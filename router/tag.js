...
const { workerAccess } = require("../middleware/authing.js");

// List Tag
tagRouter.get("/list", workerAccess, async (req, res) => {
  try {
...
// Create Tag
tagRouter.post("/post", workerAccess, async (req, res) => {
  try {
    const { name } = req.body;
...
// Update Tag
tagRouter.put("/edit/:id", workerAccess, async (req, res) => {
  try {
...
// Destroy Tag
tagRouter.delete("/delete/:id", workerAccess, async (req, res) => {
  try {
    const id = req.params.id;
